...
const apiUrlLocation = import.meta.env.API_URL_LOCATION;
...
// [] تعني أن هذا التأثير سيعمل مرة واحدة عند التحميل
    ...
    return (
      <div className="bg-gray-100 text-gray-900 min-h-screen overflow-hidden" dir="rtl">
        ...
        {/* Header Section */}
        <header
          className="bg-[url('src/assets/image1.jpg')] bg-cover bg-center bg-no-repeat text-white p-32 pt-1 shadow-lg rounded-b-2xl"
